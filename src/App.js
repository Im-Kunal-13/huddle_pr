...
function App() {
  ...
  const huddleClient = getHuddleClient("6b98b2fb37f95d68e4a32e4467f71146840e03e8f256510d40af4397cc16370d");
  ...
  const handleJoin = async () => {
    try {
      await huddleClient.join("rDVjHUcf4X", {
        address: address,
        wallet: "metamask",
        ens: "shivrxj.lens",
      });
  ...
  return (
    ...
    <div className="main">
      ...
      <button onClick={handleJoin}>Join IN</button>
      <button onClick={allowAll}>Allow ALL</button>
      {true && renderMeetContainer()}
